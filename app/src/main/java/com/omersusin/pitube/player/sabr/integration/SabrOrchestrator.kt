...
import com.omersusin.pitube.player.sabr.core.SabrEvent
import com.omersusin.pitube.player.sabr.core.SabrStreamController
...
class SabrOrchestrator(
    ...
    private fun bufferedAheadMs(state: com.omersusin.pitube.player.sabr.core.SabrSessionState): Long {
    ...
    private fun targetReadaheadMs(state: com.omersusin.pitube.player.sabr.core.SabrSessionState): Long =
