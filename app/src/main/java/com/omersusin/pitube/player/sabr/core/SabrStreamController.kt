...
import com.omersusin.pitube.player.sabr.network.SabrDataSource
import com.omersusin.pitube.player.sabr.proto.FormatBufferedRange
import com.omersusin.pitube.player.sabr.proto.FormatId
import com.omersusin.pitube.player.sabr.proto.FormatInitializationMetadata
import com.omersusin.pitube.player.sabr.proto.MediaHeader
import com.omersusin.pitube.player.sabr.proto.NextRequestPolicy
import com.omersusin.pitube.player.sabr.proto.PlaybackStartPolicy
...
import com.omersusin.pitube.player.sabr.proto.SabrError
import com.omersusin.pitube.player.sabr.proto.SabrRedirect
import com.omersusin.pitube.player.sabr.proto.SabrSeek
import com.omersusin.pitube.player.sabr.proto.StreamProtectionStatus
import com.omersusin.pitube.player.sabr.ump.UmpFrame
import com.omersusin.pitube.player.sabr.ump.UmpFrameDecoder
import com.omersusin.pitube.player.sabr.ump.UmpPartType
import com.omersusin.pitube.player.sabr.ump.SabrMediaPayload
...
class SabrStreamController(
    ...
    private suspend fun trackMedialessResponses() {
        ...
        if (consecutiveMedialessResponses >= MAX_MEDIALESS_RESPONSES) {
            ...
            com.omersusin.pitube.player.error.PlayerDiagnostics.logError(
    ...
    private suspend fun handleReloadRequired(frame: UmpFrame) {
        ...
        val token = try {
            var t: String? = null
            com.omersusin.pitube.player.sabr.proto.ProtobufReader(frame.payload).forEachField { field ->
                if (field.fieldNumber == 1) {
                    com.omersusin.pitube.player.sabr.proto.ProtobufReader(field.asBytes()).forEachField { inner ->
        ...
        com.omersusin.pitube.player.error.PlayerDiagnostics.logWarning(
