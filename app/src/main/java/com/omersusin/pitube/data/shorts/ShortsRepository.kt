...
import com.omersusin.pitube.data.model.ShortsSequenceResult
...
class ShortsRepository private constructor(private val context: Context) {
    ...
    private suspend fun fetchDiscoveryFeed(): ShortsSequenceResult {
        ...
        val discoveryVideos: List<com.omersusin.pitube.data.model.Video> =
    ...
    private fun deduplicateByTitle(
        videos: List<com.omersusin.pitube.data.model.Video>
    ): List<com.omersusin.pitube.data.model.Video> {
        if (videos.size <= 1) return videos

        val result = mutableListOf<com.omersusin.pitube.data.model.Video>()
