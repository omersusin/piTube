...
import com.omersusin.pitube.data.innertube.RssSubscriptionService
...
import com.omersusin.pitube.data.subscriptions.SubscriptionFeedMerger.preservingEnrichedMetadata
...
private fun ChannelRssEntry.toEntity(
    ...
    channelId = channelId,
    thumbnailUrl =
        com.omersusin.pitube.utils.ThumbnailUrlResolver
