...
import com.omersusin.pitube.ui.components.AddToPlaylistDialog
import com.omersusin.pitube.ui.components.VideoInfoSection
...
fun VideoInfoContent(
    ...
    val isVideoSaved by remember(video.id) { viewModel.isVideoSavedToAnyPlaylist(video.id).collectAsState(initial = false) }
