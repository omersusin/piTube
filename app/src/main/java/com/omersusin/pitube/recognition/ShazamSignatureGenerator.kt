...
/**
 * Pure-Kotlin Shazam "DejaVu" audio fingerprint generator. Direct port of the
 * GPL-3.0 `ShazamSignatureGenerator` from rukamori/ArchiveTune (and its
 * sibling vivizzz007/vivi-music), which itself mirrors the public songrec
 * algorithm. Produces a `data:audio/vnd.shazam.sig;base64,...` URI that the
 * legacy Shazam discovery endpoint accepts.
 */
...
class ShazamSignatureGenerator(
    private val maxTimeSeconds: Double = 12.0,
