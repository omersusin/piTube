            ...
            FlowCrashReportSnapshot(
                ...
                stackTrace = """
                    java.lang.OutOfMemoryError: Failed to allocate
                        at com.omersusin.pitube.player.PlayerCacheManager.updateCache(PlayerCacheManager.kt:42)
                        at com.omersusin.pitube.service.VideoPlayerService.onStartCommand(VideoPlayerService.kt:121)
