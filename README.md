...
- **Enhanced player** — storyboard hover previews on the seek bar, double-tap to seek, background playback, speed control, audio-only mode, volume normalization, sleep timer, playback queue with **related-video radio mode** and **swipe-to-remove**, **crossfade between queue items**, configurable playback-notification buttons (like/dislike/radio), **most-played history sort**, live chat polling
